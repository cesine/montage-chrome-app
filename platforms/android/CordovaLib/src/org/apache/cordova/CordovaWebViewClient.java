 ...
 * @see <a
 *      href="http://developer.android.com/guide/webapps/webview.html">WebView
 *      guide</a>
...
public class CordovaWebViewClient extends WebViewClient {
	...
	public boolean shouldOverrideUrlLoading(WebView view, String url) {
		...
		// All else
			...
			// If our app or file:, then load into a new Cordova webview
	...
	public void onPageStarted(WebView view, String url, Bitmap favicon) {
		...
		// Notify all plugins of the navigation, so they can clean up if
		// necessary.
	...
	public void onPageFinished(WebView view, String url) {
		...
		// Make app visible after 2 sec in case there was a JS error and Cordova
		// JS never initialized correctly
	...
	public void onReceivedSslError(WebView view, SslErrorHandler handler,
		...
		final PackageManager pm = this.cordova.getActivity()
				.getPackageManager();
